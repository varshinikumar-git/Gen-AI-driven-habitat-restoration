...
# Paths
train_dir = "/nfsshare/c2321/varshini/pix2pix_dataset_pair1/train"
val_dir = "/nfsshare/c2321/varshini/pix2pix_dataset_pair1/val"
save_dir = "/nfsshare/c2321/varshini/pix2pix_checkpoints"
...
def save_generated_outputs(folder, output_folder):
    ...
    for file in files:
        ...
        # Save concatenated image (input | generated | target)
